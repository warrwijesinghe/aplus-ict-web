...
ARG VITE_DIRECTPAY_MERCHANT_ID=
ARG VITE_DIRECTPAY_API_KEY=
ARG VITE_DIRECTPAY_ENV=development
ENV VITE_APP_NAME=$VITE_APP_NAME \
    VITE_APP_ENV=$VITE_APP_ENV \
    VITE_API_URL=$VITE_API_URL \
    VITE_API_TIMEOUT_MS=$VITE_API_TIMEOUT_MS \
    VITE_ENABLE_API_DEBUG=$VITE_ENABLE_API_DEBUG \
    VITE_DIRECTPAY_MERCHANT_ID=$VITE_DIRECTPAY_MERCHANT_ID \
    VITE_DIRECTPAY_API_KEY=$VITE_DIRECTPAY_API_KEY \
    VITE_DIRECTPAY_ENV=$VITE_DIRECTPAY_ENV
