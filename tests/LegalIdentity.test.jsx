...
test('footer shows the brand and central legal identity', async () => {
  ...
  expect(screen.getByText('© 2026 Miracle Network and Solutions (Pvt) Ltd. All rights reserved.')).toBeInTheDocument();
  ['Privacy Policy', 'Terms and Conditions', 'Refund Policy', 'Cancellation Policy', 'Payment Policy'].forEach((label) => expect(screen.getByRole('link', { name: label })).toBeInTheDocument());
