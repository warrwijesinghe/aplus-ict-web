...
`/login/success` is a compatibility redirect to `/login` and never reads a token from its fragment. Authentication and account transitions clear cached user data.
